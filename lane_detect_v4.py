...
tracking_data = pd.read_csv('te_run_man_data_fb.csv')

# calc area of rectangle formed by 4 defenders
...
spacing_df.to_csv('te_defender_spacing_change_man.csv', index=False)
